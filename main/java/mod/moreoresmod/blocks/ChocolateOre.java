...
public class ChocolateOre extends Block{

	public ChocolateOre(Material material) {
		super(material);
		...
		this.setBlockTextureName("MoreOresMod:ChocolateOre");
    ...
    {
	    return MoreOresModCore.foodChocolate;
    }
